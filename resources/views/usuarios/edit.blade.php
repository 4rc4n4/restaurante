                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('usuarios.update', $usuario->id) }}" class="max-w-md mx-auto bg-transparent shadow-md rounded px-8 pt-6 pb-8 mb-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <label for="telefono_contacto" class="block text-gray-700 text-sm font-bold mb-2">Teléfono de contacto:</label>
                            ...
                            <div>
                                ...
                                <input id="puesto" name="puesto" type="text" placeholder="Puesto del usuario"
                                       value="{{ $usuario->puesto }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                            </div>

                            <div>
                                <label for="numero_seguro_social" class="block text-gray-700 text-sm font-bold mb-2">Número de Seguro Social:</label>
                            ...
                            <div>
                                <label for="sueldo_diario" class="block text-gray-700 text-sm font-bold mb-2">Sueldo Diario:</label>
